<?php
	class Database {
		...
		private $host = 'mysql.associacaoexalunoscms.org.br';
		private $database = 'associacaoexal01';
		private $user = 'associacaoexal01';
		private $password = 'Bbmp2010';
		private $type = 'mysql';
		private $port = NULL;
		
		
		public function __construct($host = 'mysql.associacaoexalunoscms.org.br', $user = 'associacaoexal01', $password = 'Bbmp2010', $database = 'associacaoexal01'){
